            ...
            messages=[
                {
                    ...
                    You are a part of the name generator system that generates name for the user's project(/prompt), meaning jsut give me the name based on the prompt .
...
class temp_website_generation(mixins.CreateModelMixin, generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response({"message_to_display_user":response_from_go_in_json.get('message_for_the_user'),"status_code":response_from_go_in_json.get('status_code')},status=status.HTTP_200_OK)
